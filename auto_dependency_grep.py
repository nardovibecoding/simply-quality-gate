...
_CROSS_REPO_MAP = {
    ...
    "hook_base.py":               ["claude-sec-ops-guard", "simply-quality-gate", "claude-skills-curation"],
    "test_helpers.py":            ["claude-sec-ops-guard", "simply-quality-gate"],
    "auto_copyright_header.py":   ["claude-sec-ops-guard", "simply-quality-gate"],
    "auto_license.py":            ["claude-sec-ops-guard", "simply-quality-gate"],
    ...
    "auto_test_after_edit.py":    ["claude-sec-ops-guard", "simply-quality-gate"],
    "auto_review_before_done.py": ["claude-sec-ops-guard", "simply-quality-gate"],
    "verify_infra.py":            ["claude-sec-ops-guard"],
    "pre_commit_validate.py":     ["claude-sec-ops-guard", "simply-quality-gate"],
    "reasoning_leak_canary.py":   ["claude-sec-ops-guard"],
    "skill_disable_not_delete.py":["claude-sec-ops-guard"],
    "unicode_grep_warn.py":       ["claude-sec-ops-guard", "simply-quality-gate"],
